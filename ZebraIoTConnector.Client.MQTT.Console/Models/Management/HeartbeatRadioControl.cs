...
namespace ZebraIoTConnector.Client.MQTT.Console.Models.Management
{
    ...
    public class HeartbeatRadioControl
    {
        ...
        [JsonProperty(PropertyName = "radioActivity")]
        ...
        [JsonProperty(PropertyName = "radioConnection")]
        ...
        [JsonProperty(PropertyName = "numRadioPacketsRxed")]
        ...
        [JsonProperty(PropertyName = "numTagReads")]
        ...
        [JsonProperty(PropertyName = "numTagReadsPerAntenna")]
